...
(function (j, b, d) {
    ...
    var f = MathJax.Object.Subclass({
        ...
        loadError: function (m) {
            ...
            b.Startup.signal.Post("HTML-CSS Jax - web font error for " + d.fontInUse + "/" + m.directory)
        },
    ...
    d.Augment({
        ...
        preTranslate: function (s) {
            var r = s.jax[this.id],
                ...
                A, q = this.config.linebreaks.automatic,
        ...
        getBorders: function (r) {
            ...
            for (var s in o) {
                if (o.hasOwnProperty(s)) {
                    ...
                    if (q) {
                        n = true;
                        o[s] = this.border2em(r.style[m + "Width"] || i.LINETHICKNESS.MEDIUM);
        ...
        i.mbase.Augment({
            ...
            HTMLautoload: function () {
                this.constructor.Augment({
                    toHTML: i.mbase.HTMLautoloadFail
                });
